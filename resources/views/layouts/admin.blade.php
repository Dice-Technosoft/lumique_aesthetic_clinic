        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <div class="sidebar-menu-scroll">
                <ul class="sidebar-nav">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.inquiries') }}" class="nav-link {{ request()->routeIs('admin.inquiries*') ? 'active' : '' }}" data-title="Inquiries & Bookings">
                            <span class="nav-icon">
                            ...
                            <span class="nav-label">Inquiries & Bookings</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.leads') }}" class="nav-link {{ request()->routeIs('admin.leads*') ? 'active' : '' }}" data-title="Leads & CRM">
                            <span class="nav-icon">
                                <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                            </span>
                            <span class="nav-label">Leads & Follow-ups</span>
                        </a>
                    </li>
                    <li class="nav-item">
